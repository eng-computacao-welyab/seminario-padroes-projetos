package dev.welyab.bict.engcomp.designpatterns.publishersubscriber.sincrono.vendas;

import dev.welyab.bict.engcomp.designpatterns.publishersubscriber.sincrono.estoque.SistemaEstoque;
import dev.welyab.bict.engcomp.designpatterns.publishersubscriber.sincrono.estoque.modelo.ClienteEstoque;
import dev.welyab.bict.engcomp.designpatterns.publishersubscriber.sincrono.estoque.modelo.EnderecoEstoque;
import dev.welyab.bict.engcomp.designpatterns.publishersubscriber.sincrono.estoque.modelo.PedidoEstoque;
import dev.welyab.bict.engcomp.designpatterns.publishersubscriber.sincrono.estoque.modelo.ProdutoEstoque;
